...
- [ ] **Dogfood steps 4–5** — an agent running the recipe it was given, and the proof. The core loop has been exercised through step 3 of 5; nothing below this line is worth more than finishing it ([docs/dogfood.md](docs/dogfood.md))
