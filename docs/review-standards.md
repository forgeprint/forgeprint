...
| [EN 301 549](https://www.etsi.org/deliver/etsi_en/301500_301599/301549/04.01.01_60/en_301549v040101p.pdf) | **V4.1.1**, published September 2026; V3.2.1 (2021) stays the cited version until V4.1.1 is in the Official Journal | 2026-09-25 | The European harmonised standard the European Accessibility Act and the Web Accessibility Directive point at. V4.1.1 adopts WCAG 2.2 for web content, software and documents, so a finding already cited against a WCAG 2.2 success criterion needs no second citation. Cite a clause here only for what WCAG does not cover, such as clause 11 software and platform accessibility features, and say which version the finding rests on while V3.2.1 is still the legal reference |
