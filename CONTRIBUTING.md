...
| `pnpm forgeprint similarity <slug>` | duplicate report against the closest blueprint  | phase 1   |
| `pnpm forgeprint lint-setup <slug>` | setup.md structure and safety rules             | phase 1   |
